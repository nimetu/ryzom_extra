...
abstract class AbstractSheetExport implements ExportInterface
{
    ...
    {
        $all_stats =
            'durability|lightness|sap_load|dmg|speed|range|dodge_modifier|parry_modifier|adversary_dodge_modifier|adversary_parry_modifier|protection_factor|max_slashing_protection|max_smashing_protection|max_piercing_protection'
    ...
    protected function getStatIndex($name)
    {
        $statNames = array(
            ...
            'dodge_modifier',
            'parry_modifier',
            'adversary_dodge_modifier',
            'adversary_parry_modifier',
            'protection_factor',
            'max_slashing_protection',
            'max_smashing_protection',
            'max_piercing_protection',
            'acid_protection',
            'cold_protection',
            'rot_protection',
            'fire_protection',
            'shockwave_protection',
            'poison_protection',
            'electric_protection',
            'desert_resistance',
            'forest_resistance',
            'lake_resistance',
            'jungle_resistance',
            'prime_roots_resistance',
            'elemental_cast_speed',
            'elemental_power',
            'off_affliction_cast_speed',
            'off_affliction_power',
            'def_affliction_cast_speed',
            'def_affliction_power',
            'heal_cast_speed',
            'heal_power',
        );
