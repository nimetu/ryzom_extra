...
class RyzomExtraDataTest extends \PHPUnit\Framework\TestCase
{
     ...
     * Translation data
     */
    public static function translationDataProvider()
    {
        return [
            [
                'languagename.uxt',
            ...
            [
                'marauder_light_melee_fighter_b.outpost_squad',
                'name',
                [
            ...
            [
                'driller_bountybeaches_kami_u1_100a.outpost_building',
                'name',
                [
     ...
     */
    public static function replacedPlaceholderTextProvider()
    {
        return [
